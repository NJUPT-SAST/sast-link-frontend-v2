export function HomeSkeleton() {
  return (
    <section
      ...
      className="flex min-h-[calc(100vh-4rem)] snap-start flex-col items-center justify-center px-5 pt-16 text-center sm:px-8"
    >
      <div className="flex max-w-xl flex-col items-center gap-5">
        ...
        <div className="skeleton skeleton-shimmer h-5 w-40" />
